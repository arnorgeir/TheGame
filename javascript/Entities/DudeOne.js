...
DudeOne.prototype.update = function (du) {
    ...
    if (hitEntity) {
        ...
        if (canTakeHit && !this._isDying) {
            ...
            if (hitEntity.isBaddie && !hitEntity._isDying) this.doFunnyDeath();
...
DudeOne.prototype.findASafePlace = function (du) {
    var prevX = this.cx,
        deathX = this.death_cx,
        newX = 0,
        newY = 0,
        startX = this.reset_cx,
        startY = this.reset_cy,
        checkpointOneX = 504,
        checkpointOneY = 384,
        checkpointTwoX = 1152,
        checkpointTwoY = 456,
        checkpointThreeX = 1752,
        checkpointThreeY = 456;
