...
LevelTwo.prototype.render = function (ctx) {
   ...
   if (g_renderSpatialDebug) {
      for (var i = 0; i < this.walkTileLoc.length; i++) {
         util.fillBox(
            ctx,
            this.walkTileLoc[i].x,
            this.walkTileLoc[i].y,
            this._tileWidth,
            this._tileHeight,
            "red"
         );
         ...
         if (this.walkTileLoc[i].walkLeft) {
            ctx.moveTo(
               this.walkTileLoc[i].x + this._tileWidth/2,
               this.walkTileLoc[i].y + this._tileHeight/2
            );
            ctx.lineTo(
               this.walkTileLoc[i].x,
               this.walkTileLoc[i].y + this._tileHeight/2
         ...
         if (this.walkTileLoc[i].walkRight) {
            ...
            ctx.lineTo(
               this.walkTileLoc[i].x + this._tileWidth,
               this.walkTileLoc[i].y + this._tileHeight/2
            );
         }
         if (this.walkTileLoc[i].walkDown) {
            ...
            ctx.lineTo(
               this.walkTileLoc[i].x + this._tileWidth/2,
               this.walkTileLoc[i].y + this._tileHeight
            );
         }
